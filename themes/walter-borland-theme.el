...
(deftheme walter-borland "Borland (white on blue)" :background-mode "dark" :kind "color-scheme" :family "dark" )
  (custom-theme-set-faces 'walter-borland
   '(default ((t (:foreground "#c0c0c0" :background "#000080" ))))
   '(cursor ((t (:foreground "#000000" :background "#ff0000" ))))
   '(fringe ((t (:background "#000080" ))))
   ...
   '(font-lock-doc-face ((t (:foreground "#c0c0c0" ))))
   '(font-lock-doc-markup-face ((t (:foreground "#c0c0c0" ))))
   ...
   '(minibuffer-prompt ((t (:foreground "#c0c0c0" :bold t ))))
