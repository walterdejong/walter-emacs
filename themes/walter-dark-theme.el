;;
;;  walter-dark-theme.el
;;
;;  * btw, `M-x list-faces-display` shows all possible faces
;;

(deftheme walter-dark "Walter in the Dark" :background-mode "dark" :kind "color-scheme" :family "dark")
  (custom-theme-set-faces 'walter-dark
