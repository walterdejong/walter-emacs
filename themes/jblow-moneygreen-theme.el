...
(deftheme jblow-moneygreen "Dark green theme based on twitch.tv/j_blow" :background-mode "dark" :kind "color-scheme" :family "dark")
  (custom-theme-set-faces 'jblow-moneygreen
   '(default ((t (:foreground "#d3b58c" :background "#062626" ))))
   '(cursor ((t (:foreground "#000000" :background "#00aa00" ))))
   '(fringe ((t (:background "#24292e" ))))
   '(line-number ((t (:foreground "#838994" :background "#24292e" ))))
   '(line-number-current-line ((t (:foreground "#e1e4e8" :background "#24292e" ))))
   '(mode-line ((t (:foreground "#24292e" :background "#d3b58c" ))))
   '(region ((t (:background "#0000ee" ))))
   '(secondary-selection ((t (:background "#3e3834" ))))
   '(font-lock-builtin-face ((t (:foreground "#2ae47c" ))))
   '(font-lock-comment-face ((t (:foreground "#00dd00" ))))
   '(font-lock-constant-face ((t (:foreground "#2ae47c"))))
   '(font-lock-doc-face ((t (:foreground "#00dd00" ))))
   '(font-lock-doc-markup-face ((t (:foreground "#00dd00" ))))
   '(font-lock-function-name-face ((t nil)))
   '(font-lock-keyword-face ((t (:foreground "#ffffff" ))))
   '(font-lock-number-face ((t (:foreground "#2ae47c"))))
   '(font-lock-operator-face ((t nil)))
   '(font-lock-punctuation-face ((t nil)))
   '(font-lock-misc-punctuation-face ((t nil)))
   '(font-lock-preprocessor-face ((t (:foreground "#ffffff"))))
   '(font-lock-string-face ((t (:foreground "#29d3aa" ))))
   '(font-lock-type-face ((t (:foreground "#2ae47c" ))))
   '(font-lock-variable-name-face ((t (:foreground "#d3b58c" ))))
...
(provide-theme 'jblow-moneygreen)
