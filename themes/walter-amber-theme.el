;;
;;  walter-amber-theme.el
;;
;;  * btw, `M-x list-faces-display` shows all possible faces
;;

(deftheme walter-amber "Walter in Amber" :background-mode "dark" :kind "color-scheme" :family "dark")
  (custom-theme-set-faces 'walter-amber
   '(default ((t (:foreground "#ffbb00" :background "#000000" ))))
   '(cursor ((t (:foreground "#000000" :background "#00aa00" ))))
   '(fringe ((t (:background "#1c2024" ))))
   '(line-number ((t (:foreground "#c1c4c8" :background "#1c2024" ))))
   '(line-number-current-line ((t (:foreground "#ffbb00" :background "#1c2024" ))))
   '(mode-line ((t (:foreground "#000000" :background "#ffbb00" ))))
   '(region ((t (:background "#555555" ))))
   '(secondary-selection ((t (:background "#be5046" ))))
   '(font-lock-builtin-face ((t (:foreground "#ffcc44" ))))
   '(font-lock-comment-face ((t (:foreground "#cc9900" ))))
   '(font-lock-constant-face ((t (:foreground "#ffcc44"))))
   '(font-lock-doc-face ((t (:foreground "#cc9900" ))))
   '(font-lock-doc-markup-face ((t (:foreground "#cc9900" ))))
   '(font-lock-function-name-face ((t (:foreground "#ffbb00"))))
   '(font-lock-keyword-face ((t (:foreground "#ffcc44" ))))
   '(font-lock-number-face ((t (:foreground "#ffcc44"))))
   '(font-lock-operator-face ((t (:foreground "#ffbb00"))))
   '(font-lock-punctuation-face ((t (:foreground "#ffbb00"))))
   '(font-lock-misc-punctuation-face ((t (:foreground "#ffbb00"))))
   '(font-lock-preprocessor-face ((t (:foreground "#ffbb00"))))
   '(font-lock-string-face ((t (:foreground "#cc9900" ))))
   '(font-lock-type-face ((t (:foreground "#ffbb00" ))))
   '(font-lock-variable-name-face ((t (:foreground "#ffbb00"))))
